...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_interactions_assistant_thread_id"),
        "interactions",
        ["assistant_thread_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interactions_thread_ts"), "interactions", ["thread_ts"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_interactions_assistant_thread_id"), table_name="interactions"
    )
