...
from nurai.knowledge_sources.confluence.source import ConfluenceSource
...
async def load_knowledge_from_confluence(
    request: ConfluenceOptions,
    background_tasks: BackgroundTasks,
    open_ai_client=Depends(get_open_ai_client),
    db=Depends(get_db),
):
    background_tasks.add_task(
        load_knowledge_from_confluence_background, request, open_ai_client, db
    )
